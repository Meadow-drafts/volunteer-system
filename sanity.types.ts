...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | SanityAssetSourceData | Opportunity | Slug | Author | Markdown;
...
// Variable: OPPORTUNITY_VIEWS_QUERY
// Query: *[_type == 'opportunity' && _id==$id][0]{    _id,    views  }
export type OPPORTUNITY_VIEWS_QUERYResult = {
  _id: string;
  views: number | null;
} | null;
